...
import HexagonBackground from "./hexagon-bg";
...
export default function Hero() {
  ...
  useEffect(() => {
    const seq = [
      { el: line1Ref.current, delay: 600 },
      { el: line2Ref.current, delay: 800 },
      { el: subRef.current, delay: 1000 },
  ...
  return (
    <section className="relative flex min-h-[100dvh] items-center overflow-hidden bg-bg-primary">
      {/* Animated hexagon SVG background */}
      <HexagonBackground />

      {/* Radial red accent — top right */}
      <div className="pointer-events-none absolute -top-[20%] -right-[10%] z-[1] h-[80%] w-[60%] rounded-full bg-[radial-gradient(ellipse,rgba(233,31,39,0.04)_0%,transparent_70%)]" />
